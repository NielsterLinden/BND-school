...
## 3. Numbers on screen
Result version: **z-mumu frozen result, 17 Sep 2026** (`docs/FREEZE.md`, tag `zmumu-freeze-2026-09-17`,
...
- **Renumbered.** The rule "clip numbers are never renumbered" (02-deliverables-and-naming.md) is set aside for
  this section once: 4-01…4-21 in play order. The superseded MP4s were removed on 18 Sep 2026 (git history,
