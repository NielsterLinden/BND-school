...
| `channel-animation-director` | **entry point for a channel team**: long interview → chapter brief → orchestrates the agents below and above → drafts to critique → delivery | `setup_and_reference/briefs/<chapter>.md`, the team's rows of `03-…` | ffmpeg (preview) |
...
Teams start from `prompts/presentation_chapter_animations.md` (paste it into
