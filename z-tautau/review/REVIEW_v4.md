...
`external/trigger_insitu_v4.json`, the post-fit plots, and the shared `docs/CONVENTIONS.md` and
...
The fit inputs follow `docs/CONVENTIONS.md` §3 exactly where z-ee does not: every theory variation is
...
data (status 0). The luminosity, cross-section and sample conventions match `docs/CONVENTIONS.md`.
