...
The agents live in `.claude/agents/`, where Claude Code loads them. Pull first; start Claude Code **in the repository root**
...
Work as the channel-animation-director: read .claude/agents/channel-animation-director.md
...
Keep the shared anchors of presentation/docs/06-chapter-anchors.md; everything
...
What you get back: a brief in `presentation/docs/briefs/<chapter>.md`, draft clips in
...
`presentation/docs/06-chapter-anchors.md`, the worked example
`presentation/docs/briefs/zmumu.md`.
