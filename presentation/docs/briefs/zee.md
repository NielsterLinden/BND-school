...
## 3. Numbers on screen
Result version: **z-ee delivery of 16 Sep 2026 14:44** (`z-ee/Zee_fit.tar.gz`, unchanged by the freeze, `docs/FREEZE.md`
...
| μ_Z | 0.942 ± 0.015 | Fits/Zee_fit.txt, docs/FREEZE.md | `zee_fit.json` `mu` |
| σ(60–120) | 1841 ± 30 pb vs 1954.1 ⁺¹⁵₋₂₁ pb | docs/FREEZE.md; band as in 5-33 | `zee_fit.json` `sigma`, `theory` (`published` is frozen but not drawn) |
