...
"""Step 2 (v4) -- v4 skims -> flat ntuples of the lepton channels (docs/10-v4-plan.md sections 2-3, 10).
    ...
    python scripts/step2_ntuples_lepton.py                          # every sample with v4 skims, all channels
    python scripts/step2_ntuples_lepton.py --samples DY_NLO --channels mutau --max-files 2
