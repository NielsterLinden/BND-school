...
> Moved here from `z-mumu/` on 18 Sep 2026. Paths in this document are relative to `z-mumu/` (`docs/…`, `fit/…`, `review/…`).
...
| F8 `MuonReco` | 0.4 %/muon fully correlated → 0.8 % per event (`docs/CONVENTIONS.md` updated) | +0.77 % impact; total systematic 1.57 % instead of 1.40 % |
...
`MET_Unclustered` nuisance parameter already foreseen in `docs/CONVENTIONS.md`. The Z-p_T
