...
* Make the Tight working point nominal (`BND_TAUTAU_WP=Tight`): +11.6/−10.2 % instead of +14.5/−12.5 % on μ_Z,
  GoF p = 0.32 instead of 0.01 (`docs/08`, working-point cross-check). Then update every number in docs/, README, handoff.
