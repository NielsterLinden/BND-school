...
re-edited. TRExFitter **v1.8.0** is used everywhere. It is not part of this repository:
`fitting/build_trexfitter.sh` clones tag v1.8.0 next to the repository and builds it against the LCG ROOT.
