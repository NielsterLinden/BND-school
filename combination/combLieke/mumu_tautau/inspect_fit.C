...
void inspect_fit() {
  TFile file("results/combLieke/Fits/combLieke.root");
  ...
  TFile wsfile("results/combLieke/ws_combined.root");
  ...
  std::ofstream out("fit_diagnostics.json"); out << std::setprecision(16);
